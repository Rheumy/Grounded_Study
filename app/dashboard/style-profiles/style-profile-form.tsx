...
export function StyleProfileForm() {
  ...
  const submit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const examplesText = (formEl.elements.namedItem("examplesText") as HTMLTextAreaElement).value;
    if (examplesText) form.append("examplesText", examplesText);
    const instructionsText = (formEl.elements.namedItem("instructionsText") as HTMLTextAreaElement).value;
    if (instructionsText) form.append("instructionsText", instructionsText);
